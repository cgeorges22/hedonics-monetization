...
//effective utility -- uses effective hedonic qualities (= standard + artificial)
double calcEffectiveUtility(firm firms[], double income, const int firmNum, double shares[], std::ofstream &testoutput, int round, bool anotation, bool cesHedonics, double cesHedonicsElastGoods, double cesHedonicsElastChars, double complementIntConstraintFactor);
...
//consumer optimization -- maximize hedonic utility with frozen firms //copilot 2026-05-10
double doPostRunConsumerOptimizationClass1(firm firms[], double wageBill, const int firmNum, int optimRounds, std::ofstream &testoutput, int numMutationPairs, int numSearchTrials, double mutScale, bool anotation, bool cesHedonics, double cesHedonicsElastGoods, double cesHedonicsElastChars, double complementIntConstraintFactor);

double doPostRunConsumerOptimizationClass2(firm firms[], double salaryBill, const int firmNum, int optimRounds, std::ofstream &testoutput, int numMutationPairs, int numSearchTrials, double mutScale, bool anotation, bool cesHedonics, double cesHedonicsElastGoods, double cesHedonicsElastChars, double complementIntConstraintFactor);
